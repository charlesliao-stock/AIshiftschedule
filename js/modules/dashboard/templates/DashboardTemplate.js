export const DashboardTemplate = {
    // 渲染身分模擬控制台 (共用)
    renderImpersonationConsole(isImpersonating) {
        return `
    ...
    renderAdmin(isImpersonating) {
        ...
        return `
            <div class="dashboard-content container-fluid p-0">
                ...
                ${this.renderImpersonationConsole(isImpersonating)}
    ...
    renderManager(isImpersonating, showConsole = false) {
        const exitBtn = isImpersonating ? `
            <button id="btn-exit-impersonate" class="btn btn-danger btn-sm shadow ms-3 animate__animated animate__pulse animate__infinite">
                <i class="fas fa-sign-out-alt me-1"></i> 退出模擬
            </button>` : '';
        ...
        return `
            <div class="container-fluid">
                ...
                ${showConsole ? this.renderImpersonationConsole(isImpersonating) : ''}
    ...
    renderUser(unitId, isImpersonating, showConsole = false) {
        const exitBtn = isImpersonating ? `
            <button id="btn-exit-impersonate" class="btn btn-danger btn-sm shadow ms-3 animate__animated animate__pulse animate__infinite">
                <i class="fas fa-sign-out-alt me-1"></i> 退出模擬
            </button>` : '';
