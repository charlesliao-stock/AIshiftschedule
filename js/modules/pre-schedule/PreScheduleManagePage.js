...
export class PreScheduleManagePage {
    ...
    async afterRender() {
        ...
        } catch(e) { console.error("單位對照表載入失敗", e); }
    ...
    // ✅ 補回遺失的 handleTypeLimitChange 函式
    ...
    // ✅ 補回遺失的 importLastMonthSettings 函式
